...
```bash
python train.py --dataset book_crossing --split split8 --co_occur_version v2 --device_id 0 \
  --gcn_layer 2 --latent_dim 256 --batch_size 512 \
  --lr 0.001 --epochs 300 --l2_reg 0.0001 \
  --k_neighbors 10 \
  --beta 2.0 --sigma 0.5 --edge_bias 0.25 \
  --gate_temp 0.4 --pop_alpha_init 0.1 \
  --attr_graph_mode none \
  --lambda_cl 0.0 \
  --no_projection_head \
  --seeds 1 2 3 4 5 \
...
python train.py --dataset book_crossing --split split8 --co_occur_version v2 --device_id 0 \
  ...
  --beta 2.0 --sigma 0.5 --edge_bias 0.25 \
  --gate_temp 0.4 --pop_alpha_init 0.1 \
  --attr_graph_mode B --k_attr 5 --gamma_attr 1.0 --deg_thresh 5 \
  --cl_option 4 --lambda_cl 0.5 --cl_temp 0.05 --cl_convergence 50 \
  --projection_head \
  --seeds 1 2 3 4 5 \
...
python train.py --dataset book_crossing --split split8 --co_occur_version v2 --device_id 0 \
  ...
  --beta 2.0 --sigma 0.5 --edge_bias 0.25 \
  --gate_temp 0.4 --pop_alpha_init 0.1 \
  --attr_graph_mode A --k_attr 5 --lambda_attr 0.1 --deg_thresh 5 \
  --cl_option 7 --lambda_cl 0.05 --cl_temp 0.05 --cl_ips_clip 10 \
  --no_projection_head \
  --seeds 1 2 3 4 5 \
...
```bash
python train.py --dataset amazon_fashion --split split8 --co_occur_version v2 --device_id 0 \
  --gcn_layer 2 --latent_dim 256 --batch_size 512 \
  --lr 0.001 --epochs 300 --l2_reg 0.0001 \
  --k_neighbors 5 \
  --beta 1.0 --sigma 0.5 --edge_bias 0.25 \
...
python train.py --dataset amazon_fashion --split split8 --co_occur_version v2 --device_id 0 \
  ...
  --lr 0.001 --epochs 300 --l2_reg 0.0001 \
  --k_neighbors 5 \
  --beta 2.0 --sigma 0.5 --edge_bias 0.1 \
  --gate_temp 0.4 --pop_alpha_init 0.5 \
  --attr_graph_mode B --k_attr 20 --gamma_attr 1.0 --deg_thresh 10 \
  --cl_option 4 --lambda_cl 0.1 --cl_temp 0.2 --cl_convergence 100 \
  --projection_head \
  --seeds 1 2 3 4 5 \
...
python train.py --dataset amazon_fashion --split split8 --co_occur_version v2 --device_id 0 \
  ...
  --lr 0.001 --epochs 300 --l2_reg 0.0001 \
  --k_neighbors 5 \
  --beta 3.0 --sigma 0.5 --edge_bias 0.25 \
  --gate_temp 0.2 --pop_alpha_init 0.5 \
  --attr_graph_mode A --k_attr 5 --lambda_attr 0.05 --deg_thresh 5 \
  --cl_option 7 --lambda_cl 0.5 --cl_temp 0.05 --cl_ips_clip 20 \
  --no_projection_head \
  --seeds 1 2 3 4 5 \
